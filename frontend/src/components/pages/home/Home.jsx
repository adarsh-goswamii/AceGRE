  ...
  return (
    <>
      ...
      <div className="services-container">
        ...
        <p className="sub-heading">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Vel expedita mollitia culpa aliquam, necessitatibus magnam pariatur animi.</p>
        <div className="cards-container">
          <div className="card">
            <p className="heading">Explore</p>
            {/* <ExploreIcon className="icon"/> */}
            <p className="details">Explore new words from our collection of selected 1500+ GRE words. We divide words lear’nt so far into four categories so you always know which words needs your attention.</p>
          </div>
          <div className="card">
          <p className="heading">Quizzes</p>
            {/* <QuizIcon className="icon"/> */}
            <p className="details">Learning thousands of words and revising them is never easy, thats why we offer custom quiz where you get words from the ones you have learned so far, emphasizing on words you previously might have trouble with.</p>
          </div>
          <div className="card">
          <p className="heading">Visualize</p>
            {/* <VisualizeIcon className="icon"/> */}
            <p className="details">Track your progress in a visually appealing way with graphs and consistency chart to help and motivate you to stay consistent through out your journey.</p>
          </div>
        </div>
