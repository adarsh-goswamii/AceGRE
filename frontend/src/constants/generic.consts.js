...
export const STEPS = ["General Instructions", "All set to go"];
...
export const LOGIN_FOR_THIS_FUTURE =
  "This is a protected feature, you need to login in able to access it.";
