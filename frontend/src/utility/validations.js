import { ENTER_A_VALID_EMAIL, PASSWORD_CASE_CHECK, PASSWORD_DIGITS_CHECK, PASSWORD_SYMBOL_CHECK, PASSWORD_TOO_SHORT } from "../constants/errorMessage.consts";
...
export const passwordStrengthCheck = (password) => {
  ...
  let symbol = 0, uppercase = 0, lowercase = 0, digits = 0;
